...
import { hashStr, ME, todayStr, uid } from '../utils/hash'
...
export const useTableStore = defineStore('tables', () => {
  ...
  function persist() {
    try { localStorage.setItem(LS, JSON.stringify(pack.value)) } catch { /* */ }
  }
  ...
  function saveWorkbook(id, workbook) {
    const t = get(id)
    if (!t) return
    t.workbook = workbook
    t.updated = todayStr()
  ...
  return {
    ...
    setType, tableFav, dirCount, itemsInDir, get,
