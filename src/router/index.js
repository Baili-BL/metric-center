...
const routes = [
  ...
  { path: '/gallery/:id?', name: 'gallery', component: () => import('../views/gallery/GalleryView.vue'), meta: { title: '图库' } },
  ...
  { path: '/tables/:id?', name: 'tables', component: () => import('../views/tables/TablesView.vue'), meta: { title: '表格' } },
